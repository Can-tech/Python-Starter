...
class QuizzInterface:
    def __init__(self, quiz_brain:QuizBrain ):
        ...
        self.question_text=self.canvas.create_text(150,125,text="Question", width=280, fill=THEME_COLOR, font=("Arial", 20, "italic"))
        self.canvas.grid(column=0, row=1, columnspan=2, pady=50)

        true_image = PhotoImage(file="TRIVIA_API/images/true.png")
        self.true_button = Button(command=self.true_pressed,image=true_image, highlightthickness=0)
        self.true_button.grid(column=0, row=2)

        false_image = PhotoImage(file="TRIVIA_API/images/false.png")
